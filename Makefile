...
# Source files
SRCS = push_swap.c input_handling.c stack_init.c stack_utils.c stack_ops.c print_swap.c print_push.c print_rotate.c print_rev_rotate.c min_max_utils.c sort_utils.c turk_utils.c
